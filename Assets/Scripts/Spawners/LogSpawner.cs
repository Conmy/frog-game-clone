    ...
    public class LogSpawner : MonoBehaviour
    {
        ...
        private IEnumerator SpawnItem()
        {
            while (generateObstacles)
            {
                ...
                var logController = go.GetComponent<LogController>();
                logController.speed = objectSpeed;
                logController.movementDirection = objectMovingRight ? Vector2.right : Vector2.left;
            }
        }
